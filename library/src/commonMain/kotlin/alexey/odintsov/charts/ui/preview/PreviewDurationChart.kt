...
fun PreviewDurationChart() {
    ...
    chartData.addEntry(app1,
        DurationEntry(now + 900_000L, null, end = "stop", "")
    )
    chartData.addEntry(app1,
        DurationEntry(now + 1_000_000L, null, end = "stop", "")
    )
    chartData.addEntry(app2,
        DurationEntry(now + 1_200_000L, begin = "start", end = null, "")
    )
    chartData.addEntry(app3,
        DurationEntry(now + 900_000L, begin = null, end = "stop", "")
    )
