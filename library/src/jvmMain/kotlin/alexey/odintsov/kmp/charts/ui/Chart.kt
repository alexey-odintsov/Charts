package alexey.odintsov.kmp.charts.ui

import alexey.odintsov.kmp.charts.model.ChartData
import alexey.odintsov.kmp.charts.model.ChartEntry
import alexey.odintsov.kmp.charts.model.ChartKey
import alexey.odintsov.kmp.charts.model.ChartType
import alexey.odintsov.kmp.charts.model.DurationChartData
import alexey.odintsov.kmp.charts.model.EventsChartData
import alexey.odintsov.kmp.charts.model.MinMaxChartData
import alexey.odintsov.kmp.charts.model.PercentageChartData
import alexey.odintsov.kmp.charts.model.SingleStateChartData
import alexey.odintsov.kmp.charts.model.StateChartData
...
fun <T> Chart(
    modifier: Modifier,
    style: ChartStyle = ChartStyle.Companion.Default,
    ...
    Box {
        ...
        if (hoveredEntry != null && isCursorInsideChart) {
            ...
            Text(
                ...
                color = if (style == ChartStyle.Companion.Default) Color.Black else Color.White,
                modifier = Modifier.absoluteOffset(xDp, yDp - 20.dp).background(if (style == ChartStyle.Companion.Default) Color.White else Color.Black)
            )
        }
    }
}
